...
//		String number = String.format("12345%4d", random.nextInt(10000)); //random AccountNumber
		String number = "123123132"; //fixed AccountNumber - test should/will fail, when ran multiple times
	...
	public void addAndDeleteBeneficiary() {
		...
		URI beneficiaryUri = restTemplate.postForLocation(BASE_URL+ "/accounts/{accountId}/beneficiaries", "David", 1);
